...
export const CloudSunIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 16.5A4.5 4.5 0 1 1 12 7.5a4.5 4.5 0 1 1 0 9z" />
        <path d="M12 2v2" />
        <path d="M12 20v2" />
...
export const GallowsIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M6 20V4h10" />
        <path d="M16 4v4" />
        <path d="M10 4V2" />
...
export const NotebookTextIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const BrainCircuitIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.006 3.412 4 4 0 0 0 .001 4.928A4 4 0 0 0 8 17a3 3 0 1 0 5.998-.001A4 4 0 0 0 18 13.5a4 4 0 0 0-2-3.5c0-.52 0-1.02-.12-1.5" />
        <path d="M12 5v-2" /><path d="M9 8h-1" /><path d="M16 8h-1" /><path d="M12 17v2" /><path d="M15 13h1" /><path d="M8 13H7" />
    </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M18 6h-4"/><path d="M20 4v4"/>
      <path d="m6 18 1.45-4.1 4.1-1.45-4.1-1.45-1.45-4.1-1.45 4.1-4.1 1.45 4.1 1.45z"/>
    </svg>
);
...
export const LightbulbIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 14v4" />
        <path d="M12 2v1.3" />
        <path d="M18.3 4.7.9 5.6" />
        <path d="M5.7 4.7.9 5.6" />
        <path d="M3.5 12H2" />
    </svg>
);

export const LightbulbOffIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M16.2 11.8a4 4 0 0 0-4.4-4.4" />
        <path d="M8.5 5.2A4 4 0 0 0 10 11c0 .8.2 1.5.5 2.1" />
        <path d="M12 14v4" />
        <path d="M9 18h6" />
        <path d="M10 22h4" />
        <path d="m2 2 20 20" />
        <path d="M12 2v1.3" />
        <path d="m18.3 4.7-.9.9" />
        <path d="m5.7 4.7.9.9" />
        <path d="M3.5 12H2" />
    </svg>
);
...
export const DoorClosedIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const Wand2Icon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m12 3-1.45 4.1-4.1 1.45 4.1 1.45 1.45 4.1 1.45-4.1 4.1-1.45-4.1-1.45z"/>
        <path d="M5 21s3.2-3.2 4.2-4.2c1-1 1-2.5 0-3.5-1-1-2.5-1-3.5 0s-4.2 4.2-4.2 4.2"/>
        <path d="m18 8 2 2"/>
    </svg>
);
